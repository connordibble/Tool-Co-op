...
class DueDatesTestCase(TestCase):
    def setUp(self):
        ...
        DueDates.objects.create(toolCategory=hammer, quantity=2, buyer="Mark", date_bought='2020-03-27 09:20', date_due='2020-03-28 09:20')
...
class HistoryTestCase(TestCase):
    def setUp(self):
        History.objects.create(customer='Mark', date_bought='2020-03-27 09:20', price=5.00, tools='hammer', state='checkout')
